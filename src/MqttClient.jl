...
Representation of a MQTT Client which provides a [`JlMQTT.MqttNetworkChannel`](@ref) to a broker.
"""
...
Constructor for [`JlMQTT.MqttClient`](@ref).

## Parameters:
\nchannel - [in] [`JlMQTT.MqttNetworkChannel`](@ref)

## Returns:
\n[out] instance of [`JlMQTT.MqttClient`](@ref)
"""
#Client constructor
