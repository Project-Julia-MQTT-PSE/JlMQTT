...
Represents the CONNECT message. Constructor: [`JlMQTT.MqttMsgConnectConstructor(clientId::String)`](@ref)
"""
...
Constructs a [`JlMQTT.MqttMsgConnect`](@ref).

## Parameters:
\nclient - [`JlMQTT.MqttClient`](@ref)
